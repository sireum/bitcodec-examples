...
object BitCodec {
  ...
  @record class Foo(
    ...
    def decode(input: MSZ[B], context: Context): Unit = {
      ...
      f2 = Reader.MS.beU7(input, context)
      Reader.MS.beBS(input, context, f3, 100)
      Reader.MS.beU8S(input, context, f4, 4)
      Reader.MS.beU16S(input, context, f5, 5)
      Reader.MS.beU32S(input, context, f6, 6)
      Reader.MS.beU64S(input, context, f7, 7)
    ...
    def encode(output: MSZ[B], context: Context): Unit = {
      ...
      Writer.beU8S(output, context, f4)
      Writer.beU16S(output, context, f5)
      Writer.beU32S(output, context, f6)
      Writer.beU64S(output, context, f7)
